...
function Hero() {
  ...
  return (
    <section className="hero d-flex flex-column flex-md-row">
      <div className="hero-text justify-content-start align-items-end">
        <div>
      ...
      <div className="form">
        <ul className="nav nav-underline form-tabs mb-3 justify-content-md-start justify-content-center">
          <li className="nav-item">
            <span
              className={`nav-link ${signInTab ? "active" : ""}`}
